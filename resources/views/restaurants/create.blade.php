            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('restaurants.store') }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input-error for="name" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="slug" value="{{ __('Slug (URL identifier)') }}" />
                        <x-text-input id="slug" class="block mt-1 w-full" type="text" name="slug" :value="old('slug')" placeholder="leave-empty-for-auto-generation" />
                        <x-text-input-error for="slug" class="mt-2" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input-error for="description" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="address" value="{{ __('Address') }}" />
                        <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address')" />
                        <x-text-input-error for="address" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="phone" value="{{ __('Phone') }}" />
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" />
                        <x-text-input-error for="phone" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="logo" value="{{ __('Logo') }}" />
                        <input id="logo" name="logo" type="file" class="mt-1" accept="image/*">
                        <x-text-input-error for="logo" class="mt-2" />
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <x-text-input type="text" class="ml-2 block w-full" value="{{ old('background_color', '#ffffff') }}" 
                                                onchange="document.getElementById('background_color').value = this.value" />
                                </div>
                                <x-text-input-error for="background_color" class="mt-2" />
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <x-text-input type="text" class="ml-2 block w-full" value="{{ old('text_color', '#000000') }}" 
                                                onchange="document.getElementById('text_color').value = this.value" />
                                </div>
                                <x-text-input-error for="text_color" class="mt-2" />
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <x-text-input type="text" class="ml-2 block w-full" value="{{ old('button_color', '#3490dc') }}" 
                                                onchange="document.getElementById('button_color').value = this.value" />
                                </div>
                                <x-text-input-error for="button_color" class="mt-2" />
                            </div>
                        </div>
                    </div>
